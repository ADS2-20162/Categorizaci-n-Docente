...
class InstitucionSerializer(serializers.ModelSerializer):
    tipo_isntitucion = serializers.SlugRelatedField(slug_field='nombre', 
    ...
    class Meta:
        model = Institucion
        fields = ('id', 'nombre','direccion', 'telefono', 'email', 'descripcion', 'estado',
         'tipo_isntitucion', 'campo_predefinido')
